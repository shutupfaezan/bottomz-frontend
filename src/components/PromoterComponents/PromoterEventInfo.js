            ...
            <form className='d-flex flex-column' style={{height: "100%", fontSize: "14px", fontWeight: "400 !important"}}>
                <div className='d-md-flex mb-2'>
                    <div className='d-flex flex-column col-lg-6 px-0 pr-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.event_name}</div>
                        )}
                    </div>
                    <div className='d-flex flex-column col-lg-6 px-0 pl-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.date}</div>
                        )}
                    </div>
                </div>
                <div className='d-md-flex mb-2'>
                    <div className='d-flex flex-column col-lg-6 px-0 pr-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.event_venue}</div>
                        )}
                    </div>
                ...
                <div className='d-md-flex mb-2'>
                    <div className='d-flex flex-column col-lg-6 px-0 pr-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.curated_by}</div>
                        )}
                    </div>  
                    <div className='d-flex flex-column col-lg-6 px-0 pl-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.timings}</div>
                        )}
                    </div>  
                </div>
                <div className='d-md-flex mb-2'>
                    <div className='d-flex flex-column col p-0'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.featuring}</div>
                        )}
                    </div>  
                </div>
                <div className='d-md-flex mb-2'>
                    <div className='d-flex flex-column col-lg-6  px-0 pr-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.price_range}</div>
                        )}
                    </div>  
                    <div className='d-flex flex-column col-lg-6 px-0 pl-md-3'>
                        ...
                        <div className="text-danger ml-2">{formik.errors.genre}</div>
                        )}
                    </div>  
                </div>
                ...
                <div className='d-flex flex-column col p-0'>
                    ...
                    {formik.touched.description && formik.errors.description && (
                        <div className="text-danger ml-2">{formik.errors.description}</div>
                    )}
                </div>
