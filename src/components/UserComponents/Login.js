      ...
      <div className='col mt-5 pt-5 pr-5 mr-4'>
        <div className='mr-5 d-flex flex-column text-center px-3' style={{color: "#ffffff99"}}>
          ...
          <form className='d-flex flex-column' style={{gap: "25px"}}>
            <Input name="email_id" type="email" icon="fa-regular fa-envelope" id="email_id" style={inputStyle} placeholder="Email address"/>
            <Input name="password" type="password" id="password" style={inputStyle} bi bi-lock-fill icon="fa-solid fa-lock" placeholder="Set a password!" icon2="fa-regular fa-eye" icon3="fa-regular fa-eye-slash"/>
            <a href="/forgot-password" className="text-right" style={{color: "white"}}>Forgot Password?</a>
            <button type="submit" className="btn mt-3 py-3" style={{borderRadius: "100px", background: "white", color: "black", fontWeight: "600", fontSize: "17px"}}>Sign In</button>
          </form>
