    ...
    <div className='' style={{position: "absolute", top: "0px", height: "100%", width: "100%", backdropFilter: "blur(10px)"}}></div>
      <div style={{paddingTop: "70px", zIndex: "2"}}>
        ...
        <div className='pb-5 col-lg-6 col-md-8 col-9 p-0 d-flex flex-column text-center mx-auto'>
          ...
          <div className='d-flex flex-column p-3' style={{border: "0.5px solid white", gap: "8px", borderRadius: "20px", backdropFilter: "blur(10px)", background: "rgba(255, 255, 255, 0.1)"}}>
      ...
      <div className='px-lg-3 px-md-5 px-md-2 d-flex flex-column mb-5 mt-3'>
