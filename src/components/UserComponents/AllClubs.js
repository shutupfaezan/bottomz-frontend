...
export default function AllClubs() {
  ...
  const [maxClubs, setMaxClubs] = useState(8);
      ...
      <div>
        <>
          ...
          <div className="mb-5 mb-2 mb-md-3 all-clubs-hero">
            <img
              src={`${process.env.PUBLIC_URL}/images/allClubsHeroLeft.svg`}
              alt=""
              className="all-clubs-pattern"
              style={{
                position: "absolute",
                top: "40%",
                left: "0",
            ...
            />
            <img
              src={`${process.env.PUBLIC_URL}/images/allClubsHeroRight.svg`}
              alt=""
              className="all-clubs-pattern"
              style={{
                position: "absolute",
            ...
            <div
              className="col-lg-8 all-clubs-hero-textdiv"
              style={{
                position: "absolute",
                top: "58%",
                left: "50%",
            ...
            >
              ...
              <p
                className="all-clubs-hero-content"
                style={{ fontWeight: "400" }}
              >
                {" "}
                These clubs have partnered exclusively with us to bring you
                events. Select any club to view available events are what they
                offer.
              </p>
            </div>
            {/* Search Bar Code */}
          ...
          <div className="px-3 px-md-5 pt-3 pb-5 p-lg-5 py-xl-5 px-xl-3">
            ...
            {recentClubs?.data.length > maxClubs && (
              <button
                style={{
                  maxWidth: "240px",
                  // width: "240px",
