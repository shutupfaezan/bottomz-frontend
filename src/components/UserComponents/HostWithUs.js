    ...
    <>
      <div className="100vh position-relative">
        ...
        <section className="position-relative p-1">
          <div
            className="mb-4 mb-md-3 d-flex flex-column justify-content-end headerHeightModifier"
            style={{
              height: "350px",
              background: "black",
              borderRadius: "20px",
          ...
          >
            ...
            <div className="text-center mb-5 topHeading">
              <h4
                className="text-white px-4 px-md-0"
                style={{ fontWeight: "700", textTransform: "uppercase" }}
              >
                Do you need help or have any questions?
              </h4>
              <p
                className="px-4 px-md-0 mt-3"
        ...
        <section className="d-flex flex-column-reverse flex-md-row my-3 my-lg-5 my-md-0 pb-lg-5 pb-md-0 pt-3 px-md-4 px-lg-5">
          <div className="col-lg-4 col-md-6 p-md-0 ContactCard">
            <div
              className="p-4 mt-lg-4 mt-lg-4 mt-md-0 pl-md-3 d-flex flex-column col"
              style={{
            ...
            >
              <h4 className="text-white px-3" style={{ fontWeight: "700" }}>
                Contact Information
              </h4>
              <p
                className="px-3"
              ...
              >
                Contact us below to hear back from us.
              </p>
              <div
                className="position-absolute text-white d-flex flex-column px-3"
                style={{
                  top: "50%",
              ...
              >
                <p>
                  <i class="fa-solid fa-phone-volume mr-3"></i> 8104217764
                </p>
                <p>
                  <i class="fa-solid fa-envelope mr-3"></i> info@bottmzup.com
                </p>
                <p>
                  <i class="fa-solid fa-location-dot mr-3"></i> 201/B, Vaishali
                  Apts, Mazgaon Mumbai-10
                </p>
              </div>
              <div
                className="d-flex mt-auto  px-3"
                style={{
                  columnGap: "20px",
                  position: "relative",
                  zIndex: "1",
              ...
              >
                <span
                  className="d-flex p-2 contact-social-icon"
                  style={{
                    width: "fit-content",
                    borderRadius: "60px",
                  }}
              ...
              <img
                ...
                src={process.env.PUBLIC_URL + "./images/Contactlines.png"}
                alt=""
              ></img>
              <div>
                <img
                  ...
                  style={{ top: "0", right: "0" }}
                  src={process.env.PUBLIC_URL + "./images/Ellipse 23058.png"}
                  alt=""
                ></img>
                <img
                  className="position-absolute"
                  style={{ top: "0", right: "0" }}
                  src={process.env.PUBLIC_URL + "./images/Ellipse 23057.png"}
                  alt=""
                ></img>
              </div>
            </div>
          ...
          <div className="pl-md-5 mt-4 pl-md-3 pl-2 pr-2 col-lg-8 pb-5">
            <div
              className="d-flex p-3 flex-wrap pb-5"
              style={{ rowGap: "35px" }}
            >
              ...
              <div className="d-flex flex-column col-lg-6 px-0 pr-lg-3">
                ...
                <div className="d-flex justify-content-center align-items-center">
                  <select
                    className="form-select w-100 px-3"
                    name="query_type"
                    id="query_type"
                  ...
                  >
                    ...
                    <option value="Forgot Promoter Credentails">
                      Forgot Promoter Credentails
                    </option>
              ...
              <div className="col pr-lg-3 p-0">
                ...
                <textarea
                  ...
                  placeholder="Breif explaination about the query"
              ...
              <div className="d-flex w-100">
                <button
                  type="submit"
                  className="btn mt-3 py-2 col-lg-3 text-white col-8 mx-auto mx-lg-0 ml-lg-auto"
              ...
              <div className="d-none d-lg-block">
                <img
                  ...
                  src={process.env.PUBLIC_URL + "./images/Arrowvector.png"}
                  alt=""
                ></img>
                <p
                  className="position-absolute text-center"
                  style={{ fontSize: "14px", bottom: "0px", right: "350px" }}
                >
                  Fill the form <br />
                  and submit
                </p>
          ...
          >
            <div className="px-md-5 px-3 mt-4">
              ...
              <ul style={{ listStylePosition: "outside" }}>
                ...
                >
                  The person who booked the ticket has a copy of it in the
                  ticket section from the hamburger menu.
                </li>
              </ul>
            </div>
            <div className="px-md-5 px-3 mt-4">
              ...
              <ul className="contact-ul">
                <li
                  className="contact-li mt-3 pl-3"
                  style={{ fontWeight: "100", color: "black" }}
                >
                  Submit a form with your email and query as "Be a promoter" and
                  we'll reach out.
                </li>
                <li
                  className="contact-li mt-3 pl-3"
                  style={{ fontWeight: "100", color: "black" }}
                >
                  If you forgot your login info send a form for the same or call
                  us (if urgent) and we'll reach out.
                </li>
                <li
                  className="contact-li mt-3 pl-3"
                  style={{ fontWeight: "100", color: "black" }}
                >
                  Incase of any issues or urgent requests/queries contect us on{" "}
                  <a
