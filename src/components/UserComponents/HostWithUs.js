    ...
    <>
      <div className='100vh position-relative'>
        ...
        <section className='position-relative p-1'>
          <div className='mb-4 mb-md-3 d-flex flex-column justify-content-end' style={{height: "350px", background: "black", borderRadius: '20px'}}>
            <div className='text-center mb-5'>
              <h4 className="text-white" style={{fontWeight: "700", textTransform: "uppercase"}}>Do you need help or have any questions?</h4>
              <p className="" style={{color: 'rgba(255, 255, 255, 0.5)'}}>Fill out this form and we will get back to you shortly!</p>
            </div>
          </div>
        </section>
        <section className='d-flex my-5 pb-5 pt-3 px-5'>
          <div className='p-4 mt-4 pl-md-3 pl-2 pr-2 col-lg-4 d-flex flex-column' style={{background: "rgba(15, 15, 15, 1)", borderRadius: "20px"}}>
            ...
            <img className="position-absolute w-100" style={{bottom: "0", left: "0"}} src={ process.env.PUBLIC_URL + "./images/Contactlines.png"}></img>
           <div>
            <img className="position-absolute"  style={{top: "0", right: "0"}} src={ process.env.PUBLIC_URL + "./images/Ellipse 23058.png"}></img>
            <img className="position-absolute"  style={{top: "0", right: "0"}} src={ process.env.PUBLIC_URL + "./images/Ellipse 23057.png"}></img>
            </div>
          </div>
          <div className='pl-md-5 mt-4 pl-md-3 pl-2 pr-2 col-lg-8 pb-5'>
            <div className="d-flex p-3 flex-wrap pb-5" style={{rowGap: "35px"}}>
              ...
              <div className='d-flex w-100'>
                <button type="submit" className="btn mt-3 py-2 col-lg-3 text-white ml-auto" onClick={formik.handleSubmit} style={{background: "rgba(0, 0, 0, 1)", borderRadius: '60px'}}>Submit</button>
              </div>
              <div>
                <img className='position-absolute' style={{bottom: "40px", right: "220px"}} src={ process.env.PUBLIC_URL + "./images/Arrowvector.png"}></img>
                <p className="position-absolute text-center" style={{fontSize: "14px", bottom: "0px", right: "350px"}}>Fill the form <br/>and submit</p>
              </div>
            </div>
          </div>
        </section>
        <section className='mx-md-5 my-5 pb-5 pt-3' style={{background: "rgba(242, 242, 242, 1)", borderRadius: "30px"}}>
