...
export default function RenderEvents(props) {
  ...
  <div class="d-flex mt-3 w-100 shadow" style={{width: "24rem", border: "1px solid rgba(0,0,0,.125)", borderRadius: "20px"}}>
    <img class="p-2 align-self-center" style={{ width: "80px", height: "80px", borderRadius: "20px"}} src="https://tse4.mm.bing.net/th?id=OIP.psvuzkUEESk_cSorKC8YJgHaEK&pid=Api&P=0" alt="Club"/>
