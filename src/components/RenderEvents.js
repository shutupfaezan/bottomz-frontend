...
export default function RenderEvents(props) {
  ...
  <div class="d-flex mt-3 w-100 shadow" style={{width: "24rem", border: "1px solid rgba(0,0,0,.125)", borderRadius: "20px"}}>
    <img class="p-2 align-self-center" style={{width: "100px", height: "100px", borderRadius: "20px"}} src="https://tse4.mm.bing.net/th?id=OIP.psvuzkUEESk_cSorKC8YJgHaEK&pid=Api&P=0" alt="Club"/>
    <div class="d-flex flex-column justify-content-center">
      ...
      <p className='m-0 text-truncate' style={{fontSize: "12px", color: "grey", width: "166px"}}>{props.identity.event_venue}</p>
      <p className='m-0' style={{fontSize: "12px", color: "grey"}}><strong>{props.identity.price}</strong></p>
    </div>
