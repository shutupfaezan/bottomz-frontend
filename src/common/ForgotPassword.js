...
export default function ForgotPassword() {
    ...
    <h4 className='mb-4 text-center'><b>Forgot Password?</b></h4>
      {stage === 1 &&  <div className='col-md-6 col-lg-4'><p className='mb-0'><b>Enter Your registered Email Id</b></p>
      ...
      {stage === 2 &&  <div className='col-md-6 col-lg-4'><p className='mb-0 d-flex flex-column align-items-center' style={{fontWeight: '400'}}>A 6-digit OTP has been sent to <b>{userEmail && userEmail}</b></p>
      ...
      {otpError}
        ...
        {stage === 3 &&  <div className='col-md-6 col-lg-4'>
