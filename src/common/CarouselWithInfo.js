  ...
  >
        ...
        return(
          <div key={index} style={{height: '100%'}}>
            <div className="d-md-flex d-black w-100 p-3" style={{height: "100%"}}>
              <div className="imageContainer p-2 col-lg-6 col-12 col-md-7 mx-lg-5 my-md-5 my-4" style={{width: "100%", border: "7px solid white", borderRadius: "15px", overflow: "hidden"}}>
                ...
                <h2 className="primary-header mb-md-4 my-2 mt-md-0" style={{color: "white"}}>{item?.event_name}</h2>
                <p className="mb-1" style={{color: "white"}}><i class="fa-regular fa-paper-plane mr-2"></i>{item?.event_venue}</p>
                <p className="" style={{color: "white"}}><i class="fa-regular fa-calendar mr-2"></i>{item?.timings.slice(0,9)} • {formatDate(item?.date)} • {item?.day}</p>
