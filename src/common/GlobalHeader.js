...
export default function GlobalHeader() {
  ...
  return (
    <>
    <div className="w-100 mx-md-auto px-3"  style={{position: "fixed", top: "30px", zIndex: "3",color: "white"}}>
      <nav className="navbar navbar-expand navbar-light align-items-center headerback py-3 py-md-4 px-3 px-lg-5 px-md-3 col-md-11 mx-auto nav-filter-backdrop">
        <a className=" navbar-brand py-0 d-flex mx-auto logo-modulator" style={{fontWeight: "800"}} href="/">
          <img className="mr-2" src={process.env.PUBLIC_URL + "/images/LOGO.svg"} style={{width: "160px", height: '35px'}} alt=""/>
        </a>
        <ul className="navbar-nav mr-2">
            <li className="nav-item active d-none d-md-flex hover-underline-animation">
              <Link className="nav-link p-2 mx-2" style={{fontSize: "19px"}} to="/clubs"><small style={{ color: "white"}}>Clubs</small></Link>
            </li>
            <li className="nav-item active d-none d-md-flex hover-underline-animation">
              <Link className="nav-link p-2 mx-2" style={{fontSize: "19px"}} to="/events"><small style={{ color: "white"}}>Events</small></Link>
            </li>
            <li className="nav-item active d-none d-md-block hover-underline-animation">
              <Link className="nav-link p-2 mx-2" style={{fontSize: "19px"}} to="/contact-us"><small style={{ color: "white"}}>Help</small></Link>
            </li>
        </ul>
        <div className="align-items-center collapse navbar-collapse text-black" id="navbarSupportedContent">
          <div className="nav-item active d-none d-md-block hover-underline-animation ml-auto mr-2">
            <Link className="nav-link p-2 mx-2" style={{fontSize: "19px", color: "black"}} to="/contact-us"><small style={{ color: "white"}}>Sell</small></Link>
          </div>
          <div className="dropleft d-md-block d-none">
            ...
            <small className="mb-0 text-black hover-underline-animation cursor-pointer" style={{ color: "white"}}>
              {sessionStorage?.username}
            </small>
            </p>
            ...
            : <p className="m-0 mr-md-4 ml-md-auto" style={{fontSize: "19px", cursor: "pointer"}}  onClick={modalswitch}><small className="profile-login-btn rounded-pill" style={{color: "black", background: "white", padding: "10px 30px", borderRadius: "20px"}}>Sign In</small></p>}
          </div>
