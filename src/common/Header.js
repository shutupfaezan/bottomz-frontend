  ...
  return (
    ...
    <div className="position-relative mb-lg-5">
      ...
      <div className='d-flex flex-column w-50 position-absolute ml-lg-5 pl-lg-5' style={{top: "50%", left: "0%", transform: " translateY(-50%)"}}>
        <h1 className='d-flex justify-content-center align-self-center mb-4 MainHeaderText primary-header' style={{fontWeight: "400", fontFamily: "Dm Sans", fontSize: "96px", color: "white", textAlign: 'left', lineHeight: '94%'}}>Lets Make Live Happen</h1>
