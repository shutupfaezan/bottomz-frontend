  ...
  return (
    ...
    <BrowserView>
      ...
      <div className='d-flex flex-column w-100 position-absolute' style={{top: "155px"}}>
        <h1 className='d-md-flex d-none justify-content-center align-self-center text-center mb-2 primary-header' style={{fontWeight: "800", fontSize: "60px", WebkitTextStroke: "1px white", color: "transparent"}}>Clubbing At Ease</h1>
    ...
    <MobileOnlyView>
      ...
      <div className='d-flex flex-column w-100 position-absolute' style={{top: "160px"}}>
        <h4 className='d-flex d-md-none justify-content-center align-self-center text-center mb-3 primary-header px-2' style={{fontWeight: "800", fontSize: "40px", WebkitTextStroke: "1px white", color: "transparent"}}>Clubbing At Ease</h4>
