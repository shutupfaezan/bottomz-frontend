    ...
    <>
      ...
      <div className='d-flex d-lg-block w-100 overflow-scroll'>
        <div class="nav nav-pills flex-column col-11 col-md-6 col-lg p-0">
          ...
          <Link to="/host-an-event" class="nav-link my-2 mb-md-3 mr-2 p-3 d-flex flex-column d-lg-block col-6 col-lg-11 mr-md-3" style={{color: window.location.hash === "#/host-an-event" ? "white": "black", border: "2px solid black", borderRadius: "10px", background : window.location.hash === "#/host-an-event" ? "black" : "white", boxShadow:  window.location.hash === "#/host-an-event" ? "5px 5px #E04949": null}} aria-current="page">
          <i class="bi bi-collection-play mr-2"></i>Host With Us
          </Link>
          <Link to="/promoter-events" class="nav-link my-2 mb-md-3 mr-2 p-3 d-flex flex-column d-lg-block col-6 col-lg-11"style={{color: window.location.hash === "#/promoter-events" ? "white": "black", border: "2px solid black", borderRadius: "10px", background : window.location.hash === "#/promoter-events" ? "black" : "white", boxShadow:  window.location.hash === "#/promoter-events" ? "5px 5px #E04949": null}}>
      ...
      <div class="nav nav-pills flex-column col-11 col-md-6 col-lg p-0 mt-auto">
        ...
        <div className='d-flex d-lg-block w-100'>
        <Link to="/host-with-us" class="nav-link my-2 mb-md-3 p-3 mr-2 d-flex flex-column d-lg-block col-6 col-lg-11 mr-md-3" aria-current="page" style={{color: "black", border: "2px solid black", borderRadius: "10px"}}>
        <i class="bi bi-question-circle mr-2"></i>Help
        </Link>
          <Link to="/" onClick={()=>{sessionStorage.clear()}} class="nav-link my-2 mb-md-3 mr-2 p-3 d-flex flex-column d-lg-block col-6 col-lg-11" style={{color: "black", border: "2px solid black", borderRadius: "10px"}}>
