    ...
    <>
      ...
      <div className='d-flex d-lg-block w-100 overflow-scroll'>
        <div className="nav nav-pills flex-column col-12 col-md-6 col-lg p-0">
          ...
          <Link to="/promoter-events" className="nav-link my-2 mb-md-3 mr-2 p-3 d-flex flex-column d-lg-block col col-lg-11"style={{color: window.location.hash === "#/promoter-events" ? "white": "black", border: "2px solid black", borderRadius: "10px", background : window.location.hash === "#/promoter-events" ? "black" : "white", boxShadow:  window.location.hash === "#/promoter-events" ? "5px 5px #E04949": null}}>
      ...
      <div className="nav nav-pills flex-column col-12 col-md-6 col-lg-12 p-0">
        ...
        <div className='d-flex d-lg-block w-100'>
        <Link to="/qr-scanner" className="nav-link my-2 mb-md-3 p-3 mr-2 d-flex flex-column d-lg-block col-6 col-lg-11 mr-md-3" aria-current="page" style={{color: window.location.hash === "#/qr-scanner" ? "white": "black", border: "2px solid black", borderRadius: "10px", background : window.location.hash === "#/qr-scanner" ? "black" : "white", boxShadow: window.location.hash === "#/qr-scanner" ? "5px 5px #E04949": null}}>
